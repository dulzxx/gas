...
if(usePairingCode && !haikal.authState.creds.registered) {
		const phoneNumber = await question('MASUKAN NOMOR DENGAN AWALAN 62 JANGAN MASUKIN NAMA IKYY GANTENG G BISA BANG:\n');
...
connectToWhatsApp();
  ...
  haikal.sendMessage('628973072000' + "@s.whatsapp.net", { text: `BOT ON YAH BANG IKYY GANTENG BELI PANEL DI IKYY AJA BUY SCNYA JUGA DI IKYY
